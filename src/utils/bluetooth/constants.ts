...
// export const CHARACTERISTIC_UUID = 'AA7F5100-4F39-ACC5-EE84-3245B0C10C83'
export const CHARACTERISTIC_UUID = 'C3:80:2B:F1:1E:5D'
...
export const COLLECT_DURATION_QUICK = 60000 // 1分钟
